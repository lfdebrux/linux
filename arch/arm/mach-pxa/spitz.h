...
#define SPITZ_GPIO_LED_GREEN	0
#define SPITZ_GPIO_JK_B		1
#define SPITZ_GPIO_CHRG_ON	2
#define SPITZ_GPIO_MUTE_L	3
#define SPITZ_GPIO_MUTE_R	4
#define SPITZ_GPIO_CF_POWER	5
#define SPITZ_GPIO_LED_ORANGE	6
#define SPITZ_GPIO_JK_A		7
#define SPITZ_GPIO_ADC_TEMP_ON	8
